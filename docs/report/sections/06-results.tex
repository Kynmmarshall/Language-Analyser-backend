...
As noted in Section~\ref{sec:data}, the statements in the table above are currently
\texttt{demo} records. Once real collected statements are entered and
\texttt{tools/export\_tables.py} is re-run, this table repopulates with the field corpus
automatically.
\end{todobox}
