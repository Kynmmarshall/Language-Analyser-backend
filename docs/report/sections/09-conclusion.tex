...
\begin{enumerate}[leftmargin=1.4em, itemsep=0.2em]
  ...
  \item \textbf{Re-export against the live corpus.} Run
        \texttt{python tools/export\_tables.py -{}-database <url> -{}-field-only}
        afterwards; all data tables in this report regenerate from the real corpus.
