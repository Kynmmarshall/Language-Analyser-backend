...
\addlinespace
\texttt{Seq} & $\rightarrow$ \texttt{Unit Seq'} & \scriptsize\texttt{demo.gram.seq4.lr} \\
\addlinespace
\texttt{Seq'} & $\rightarrow$ \texttt{CONJ Unit Seq'} & \scriptsize\texttt{demo.gram.seq1.tail} \\
\texttt{} & $\mid$ $\varepsilon$ & \scriptsize\texttt{Seq'.eps} \\
\texttt{} & $\mid$ \texttt{SEP Seq''} & \scriptsize\texttt{Seq'.factor0} \\
\addlinespace
\texttt{Unit} & $\rightarrow$ \texttt{FORMULA} & \scriptsize\texttt{demo.gram.unit3} \\
\texttt{} & $\mid$ \texttt{Clause} & \scriptsize\texttt{demo.gram.unit4} \\
\texttt{} & $\mid$ \texttt{INTJ Unit'} & \scriptsize\texttt{Unit.factor1} \\
\addlinespace
...
\addlinespace
\texttt{NP} & $\rightarrow$ \texttt{PRON} & \scriptsize\texttt{demo.gram.np3} \\
\texttt{} & $\mid$ \texttt{NOUN} & \scriptsize\texttt{demo.gram.np4} \\
\texttt{} & $\mid$ \texttt{DET NP'} & \scriptsize\texttt{NP.factor2} \\
\addlinespace
\texttt{PP} & $\rightarrow$ \texttt{PREP NP} & \scriptsize\texttt{demo.gram.pp1} \\
\addlinespace
\texttt{Seq''} & $\rightarrow$ \texttt{Unit Seq'} & \scriptsize\texttt{demo.gram.seq2.tail.tail0} \\
\texttt{} & $\mid$ \texttt{CONJ Unit Seq'} & \scriptsize\texttt{demo.gram.seq3.tail.tail0} \\
\addlinespace
\texttt{Unit'} & $\rightarrow$ \texttt{Clause} & \scriptsize\texttt{demo.gram.unit1.tail1} \\
\texttt{} & $\mid$ $\varepsilon$ & \scriptsize\texttt{demo.gram.unit2.tail1} \\
\addlinespace
\texttt{NP'} & $\rightarrow$ \texttt{NOUN} & \scriptsize\texttt{demo.gram.np1.tail2} \\
\texttt{} & $\mid$ \texttt{ADJ NOUN} & \scriptsize\texttt{demo.gram.np2.tail2} \\
\addlinespace
\end{longtable}
